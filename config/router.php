...
$router->get('admin-get-signIn','/sign-in', \NtSchool\Action\AdminSignInAction::class);
$router->post('admin-post-signIn','/sign-in', \NtSchool\Action\AdminSignInAction::class);
...
$router->get('admin-post','/admin-posts', \NtSchool\Action\AdminPostsAction::class);
